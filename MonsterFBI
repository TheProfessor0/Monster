...
def login():
	...
	try:
		...
		print logo
		print 42*"\033[1;96m="
		print('Tkaya FB Nwe Daxil Ka Agar Naikay Ba Kery Monster W Professorawa ')
...
def menu():
	...
	#INFORMATION OF USER
	print "~~~~~~~~~~~~~~~~~~~~~~~~"
	print "\x1b[32;1mMonster×FBI/ Name >>"+namefb
	print "\x1b[34;1mMonster×FBI/ ID >>"+id
	print '\x1b[33;1mMonster×FBI/ TotalSub >>'+subid
	print "~~~~~~~~~~~~~~~~~~~~~~~~"
	print ""
	print "===================="
...
def option():
	unikers = raw_input("\n\x1b[31;1mMonster\x1b[37;1mFBI>>\x1b[33;1m")
	if unikers =="":
...
def graber():
	...
	print "\x1b[31;1m{2}~~Hack KRDN La ReGaY RafiqakaniaWa"
...
def startgrab():
	...
	p = ThreadPool(30)
	p.map(main, id)
        anime("\x1b[32;1m>>>>>>>>>>>>>>>\x1b[31;1mMonster\x1b[37;1mFBI\x1b[32;1m<<<<<<<<<<<<<<<")
